    ...
    match target_os.as_str() {
        ...
        "macos" => {
            ...
            builder
                ...
                // late-cli voice is audio-only. Avoid the macOS ObjC video
                // codec factory path, which can throw uncaught VP9
                // NSExceptions on Tahoe/Apple Silicon during factory setup.
                .define("LIVEKIT_DISABLE_MACOS_OBJC_VIDEO_FACTORY", "1")
                .flag("-stdlib=libc++")
                .flag("-std=c++20")
