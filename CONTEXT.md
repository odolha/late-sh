...
|--------|-----|--------|-------------|
| **Home / Dashboard** | 1 | Active | Merged Home shell: optional chat room rail, chat center for chat/synthetic entries, and room shortcuts; the activity feed lives in the right sidebar's Activity panel. Chat details live in `late-ssh/src/app/chat/CONTEXT.md`. |
